...
-keep class com.kitabucode.bridge.** { *; }

# ----------------------------------------------------------------------------
# Application class
# ----------------------------------------------------------------------------
# Referenced by name in AndroidManifest.xml.
-keep class com.kitabucode.KitabuCodeApp { *; }
...
-keepnames class com.kitabucode.** extends java.lang.Throwable
