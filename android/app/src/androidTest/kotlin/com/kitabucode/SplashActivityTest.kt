...
import com.kitabucode.util.ServerReadyHelper
...
class SplashActivityTest {
    ...
    // FirstRunSetup writes setup_version to "kitabucode_setup"
    private fun getSetupPrefs() = context.getSharedPreferences("kitabucode_setup", Context.MODE_PRIVATE)
    // SplashActivity reads toolchain_picker_shown from "kitabucode"
    private fun getAppPrefs() = context.getSharedPreferences("kitabucode", Context.MODE_PRIVATE)
