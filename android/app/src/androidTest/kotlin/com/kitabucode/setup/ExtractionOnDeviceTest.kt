...
class ExtractionOnDeviceTest {
    ...
    private val own = "kitabucode.kitabucode-process-monitor-1.2.0"

    private val extensionsDir get() = File(sandbox, "home/.kitabucode/extensions")
    ...
    fun tearDown() {
        sandbox.deleteRecursively()
        appContext.getSharedPreferences("extraction-on-device-kitabucode_setup", Context.MODE_PRIVATE)
            .edit().clear().commit()
    }
