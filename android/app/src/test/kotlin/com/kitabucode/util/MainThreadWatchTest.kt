...
class MainThreadWatchTest {
    ...
    private val watch = File("src/main/kotlin/com/kitabucode/util/MainThreadWatch.kt")
    private val mainActivity = File("src/main/kotlin/com/kitabucode/MainActivity.kt")
    private val app = File("src/main/kotlin/com/kitabucode/KitabuCodeApp.kt")
    private val splash = File("src/main/kotlin/com/kitabucode/SplashActivity.kt")
     ...
     *
     * Moving it to `KitabuCodeApp.onCreate` or `SplashActivity.onCreate` to "cover
