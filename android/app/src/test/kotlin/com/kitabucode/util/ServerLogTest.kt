...
class ServerLogTest {
    ...
    fun `a keyword at the end of a line does not reach the frame below it`() {
        val text = "java.lang.IllegalStateException: basic\n" +
            "\tat com.kitabucode.util.Thing.doIt(Thing.kt:1)\n" +
            "java.lang.IllegalStateException: password:\n" +
            "\tat com.kitabucode.MainActivity.onCreate(MainActivity.kt:1)\n"
    ...
    private fun outputReaderBody(): String {
        val source = File("src/main/kotlin/com/kitabucode/service/ProcessManager.kt")
        assertTrue(
            source.isFile,
