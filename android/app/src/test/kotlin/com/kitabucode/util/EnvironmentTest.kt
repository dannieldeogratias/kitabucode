...
class EnvironmentTest {
    ...
    private val mockFilesDir = File("/data/data/com.kitabucode/files")
    private val mockNativeLibDir = "/data/data/com.kitabucode/nativeLibs"
    ...
    inner class ProjectsDirTest {
        ...
        fun stubStorage() {
            ...
            // java.nio as [com.kitabucode.setup.ProjectsSymlinkTest] does, which
    ...
    inner class PathConsistencyTest {
        ...
        fun `each path getter names its own destination`() {
            ...
            assertEquals("home/.kitabucode", under(Environment.getUserDataDir(context)))
            ...
            assertEquals("home/.kitabucode/extensions", under(Environment.getExtensionsDir(context)))
            assertEquals("home/.kitabucode/data/logs", under(Environment.getLogsDir(context)))
        }
    }
}
