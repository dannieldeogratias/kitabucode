...
class EnvironmentSafTest {
    ...
    private fun mockContext(filesDir: String = "/data/data/com.kitabucode/files"): Context {
    ...
    fun `getSafMirrorsDir returns correct base path`() {
        ...
        assertEquals("/data/data/com.kitabucode/files/saf-mirrors", result)
    }
    ...
    fun `getSafMirrorDir path is under saf-mirrors directory`() {
        ...
        assertTrue(
            result.startsWith("/data/data/com.kitabucode/files/saf-mirrors/"),
