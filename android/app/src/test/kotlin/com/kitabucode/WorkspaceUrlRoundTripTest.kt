...
class WorkspaceUrlRoundTripTest {
    ...
    private val workspace = "/data/user/0/com.kitabucode/files/saf-mirrors/92f67f007ab2/proj.code-workspace"
    private val folder = "/data/user/0/com.kitabucode/files/projects/site"
    ...
    fun `the directory in force for a workspace is the one holding it`() {
        assertEquals(
            "/data/user/0/com.kitabucode/files/saf-mirrors/92f67f007ab2",
    ...
    private val mirror = "/data/user/0/com.kitabucode/files/saf-mirrors/92f67f007ab2"
