...
import com.kitabucode.rememberedFolderToReopen
...
class WorkspaceMemoryTest {
    ...
    private val mirrorsRoot = "/data/user/0/com.kitabucode/files/saf-mirrors"
    ...
    fun `a folder that is gone is not reopened`() {
        assertNull(
            rememberedFolderToReopen(
                "/data/user/0/com.kitabucode/files/projects/site",
                mirrorsRoot,
                exists = { false },
    ...
    fun `an ordinary project folder needs no grant`() {
        val path = "/data/user/0/com.kitabucode/files/projects/site"
    ...
    private val source = File("src/main/kotlin/com/kitabucode/MainActivity.kt")
