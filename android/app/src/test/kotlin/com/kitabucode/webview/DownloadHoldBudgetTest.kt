...
class DownloadHoldBudgetTest {
    ...
    private val source = File("src/main/kotlin/com/kitabucode/MainActivity.kt").readText()
     ...
     * `window.__kitabucodeDownload`, and this case fails at the extraction rather
    ...
    fun `the release the page offers is the one Android calls`() {
        ...
        assertTrue(body.contains("__kitabucodeDownload") && body.contains(".release(")) {
