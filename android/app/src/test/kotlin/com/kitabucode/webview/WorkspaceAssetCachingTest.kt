...
class WorkspaceAssetCachingTest {
    ...
    private val source =
        File("src/main/kotlin/com/kitabucode/webview/KitabuCodeWebViewClient.kt").readText()
    ...
    private fun body(name: String): String {
        ...
        assertTrue(start >= 0) {
            "$name is gone from KitabuCodeWebViewClient.kt, so this test is measuring " +
        ...
        throw AssertionError("Could not find the end of $name in KitabuCodeWebViewClient.kt")
    }
