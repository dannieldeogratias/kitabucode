...
class KeygenBudgetTest {
    ...
    private val relay = File("src/main/assets/extensions")
        .listFiles { f -> f.isDirectory && f.name.startsWith("kitabucode.kitabucode-saf-bridge-") }
        ?.singleOrNull()
        ?.let { File(it, "extension.js") }
        ?: File("src/main/assets/extensions/kitabucode.kitabucode-saf-bridge/extension.js")
