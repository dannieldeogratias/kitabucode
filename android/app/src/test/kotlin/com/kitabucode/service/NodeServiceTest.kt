...
class StartCommandTest {
    ...
    fun `an action this service does not own is an ordinary start`() {
        ...
        assertEquals(
            StartCommand.SERVE,
            startCommand(
                "com.kitabucode.action.SOMETHING_ELSE",
...
class ForegroundPromotionCallSiteTest {
    ...
    private val nodeService = File("src/main/kotlin/com/kitabucode/service/NodeService.kt")
 ...
 * every later launch was a no-op, and the notification still said "KitabuCode is
...
class HeapLatchCallSiteTest {
    ...
    private val nodeService = File("src/main/kotlin/com/kitabucode/service/NodeService.kt")
    private val processManager = File("src/main/kotlin/com/kitabucode/service/ProcessManager.kt")
