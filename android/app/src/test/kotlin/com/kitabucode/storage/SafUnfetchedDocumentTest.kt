...
class SafUnfetchedDocumentTest {
     ...
     * user was told the only copy was inside KitabuCode at the moment the app held
     * none of it.
     */
    @Test
     ...
     * the document under it, and this time "the only copy is inside KitabuCode" is true
    ...
    fun `the refusal message has one home, so both sites announce`() {
        val engineSource =
            File("../../android/app/src/main/kotlin/com/kitabucode/storage/SafSyncEngine.kt")
