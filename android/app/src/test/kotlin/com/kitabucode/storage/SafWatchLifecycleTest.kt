...
class SafWatchLifecycleWiringTest {
    ...
    private val engineFile = File("src/main/kotlin/com/kitabucode/storage/SafSyncEngine.kt")
    private val managerFile = File("src/main/kotlin/com/kitabucode/storage/SafStorageManager.kt")
