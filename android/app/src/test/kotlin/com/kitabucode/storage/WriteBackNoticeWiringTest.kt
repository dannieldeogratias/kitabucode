...
class WriteBackNoticeWiringTest {
    ...
    private val activity = File("../../android/app/src/main/kotlin/com/kitabucode/MainActivity.kt")
    private val manager = File("src/main/kotlin/com/kitabucode/storage/SafStorageManager.kt")
     ...
     * not reach the editor, so "the only copy is inside KitabuCode" is the opposite of
