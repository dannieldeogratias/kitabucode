...
class MirrorLookupTest {
    ...
    private val root = "/data/user/0/com.kitabucode/files/saf-mirrors"
    ...
    fun `an ordinary project folder is not a mirror`() {
        assertNull(
            SafStorageManager.folderForOpenedPath(all, "/data/user/0/com.kitabucode/files/home/projects"),
        )
    }
    ...
    fun `the page-load callback reconciles the watcher`() {
        val source = File("src/main/kotlin/com/kitabucode/MainActivity.kt")
        check(source.isFile) {
