...
class EnvironmentPathOrderTest {
    ...
    private val nativeLibDir = "/data/app/~~hash==/com.kitabucode-hash==/lib/arm64"
    ...
    fun setUp() {
        ...
        File(filesDir, "home/.kitabucode").mkdirs()
    }
    ...
    private fun installRuby() {
        ...
        File(filesDir, "home/.kitabucode/toolchains.json").writeText(
    ...
    fun `the exported table variable names the file the manager writes`() {
        ...
        val named = Environment.buildProcessEnvironment(context, 1234)["KITABUCODE_EXEC_TABLE"]
        assertEquals(
            Environment.getExecTablePath(context), named,
            "KITABUCODE_EXEC_TABLE does not name the accessor both sides read",
        )
