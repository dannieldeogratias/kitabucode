...
class ExtensionsManifestWriteTest {
    ...
    private val dirName = "kitabucode.kitabucode-welcome-1.2.0"
    private val expectedId = "kitabucode.kitabucode-welcome"
    private val pkgJson =
        """{"publisher":"kitabucode","name":"kitabucode-welcome","version":"1.2.0"}"""
    ...
    fun setUp() {
        ...
        extensionsDir = File(filesDir, "home/.kitabucode/extensions")
    ...
    private fun stageUpgrade() {
        manifestFile.writeText(
            """[{"identifier":{"id":"kitabucode.gone"},"relativeLocation":"kitabucode.gone-1.0.0"}]"""
        )
    }
    ...
    fun `a version bump recovers its manifest after a failed write`() {
        val bumped = "kitabucode.kitabucode-welcome-1.2.1"
        val bumpedPkg = """{"publisher":"kitabucode","name":"kitabucode-welcome","version":"1.2.1"}"""
