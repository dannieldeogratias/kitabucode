...
class ToolchainInstallTest {
    ...
    fun setUp() {
        ...
        every { context.packageName } returns "com.kitabucode"
    ...
    fun `a valid manifest is recorded and reported COMPLETED`() {
        ...
        val state = File(filesDir, "home/.kitabucode/toolchains.json").readText()
    ...
    fun `a copy that cannot finish is reported as a storage problem`() {
        ...
        assertFalse(
            File(filesDir, "home/.kitabucode/toolchains.json").exists(),
    ...
    private fun blockTheRecordWrite() {
        val blocker = File(filesDir, "home/.kitabucode/toolchains.json.tmp~")
