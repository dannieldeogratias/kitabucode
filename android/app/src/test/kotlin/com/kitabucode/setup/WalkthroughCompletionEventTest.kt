 ...
 *
 * A target in our own `kitabucode.` namespace is the exception: that one IS
...
class WalkthroughCompletionEventTest {
    ...
    private fun ourManifests(): List<File> =
        extensionsDir.listFiles { f -> f.isDirectory && f.name.startsWith("kitabucode.kitabucode-") }
     ...
     *
     * A step completing on `kitabucode.something` names a command this repo
    ...
    private companion object {
        ...
        const val OUR_NAMESPACE = "kitabucode."
    }
}
