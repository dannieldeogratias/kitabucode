...
class ToolchainDigestTest {
    ...
    fun `the manifest is looked for beside the zip`() {
        assertEquals(
            "https://github.com/rmyndharis/KitabuCode/releases/latest/download/toolchains.sha256",
            manifestUrlFor(
                "https://github.com/rmyndharis/KitabuCode/releases/latest/download/toolchain_go.zip"
            ),
        )
    }
...
class LatestReleasePinningTest {
    ...
    private val zip = "https://github.com/rmyndharis/KitabuCode/releases/latest/download/toolchain_go.zip"

    @Test
    fun `the release URL is derived from an asset URL`() {
        assertEquals(
            "https://github.com/rmyndharis/KitabuCode/releases/latest",
    ...
    fun `a URL that does not go through latest resolves to nothing`() {
        ...
        assertNull(
            latestReleaseUrlFor(
                "https://github.com/rmyndharis/KitabuCode/releases/download/v1.0.0/toolchain_go.zip"
            )
        )
    }
    ...
    fun `the tag is read out of the redirect GitHub actually sends`() {
        assertEquals(
            "v1.0.0",
            releaseTagFromLocation("https://github.com/rmyndharis/KitabuCode/releases/tag/v1.0.0"),
        )
        // The server release tag is not v-prefixed, and is the one this has to
        // keep out of the app channel rather than mis-parse.
        assertEquals(
            "server-1.133.0",
            releaseTagFromLocation("https://github.com/rmyndharis/KitabuCode/releases/tag/server-1.133.0"),
        )
    }
    ...
    fun `pinning the ZIP pins the manifest beside it`() {
        ...
        assertEquals(
            "https://github.com/rmyndharis/KitabuCode/releases/download/v1.1.0/toolchains.sha256",
    ...
    fun `an install reaches the release its own version names`() {
        ...
        val go = "https://github.com/rmyndharis/KitabuCode/releases/latest/download/toolchain_go.zip"
