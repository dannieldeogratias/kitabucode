...
import com.kitabucode.SourceScan
...
class ToolchainAdapterBoundaryTest {
    ...
    private val source = File("src/main/kotlin/com/kitabucode/setup/ToolchainPickerAdapter.kt")
...
class ToolchainInstalledRebindTest {
    ...
    fun `the installed-set rebind carries a payload`() {
        val source = SourceScan.read("src/main/kotlin/com/kitabucode/setup/ToolchainPickerAdapter.kt")
