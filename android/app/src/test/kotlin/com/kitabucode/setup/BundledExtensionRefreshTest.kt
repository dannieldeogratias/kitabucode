...
class BundledExtensionRefreshTest {
    ...
    private val dirName = "kitabucode.kitabucode-process-monitor-1.0.0"

    private val extensionsDir by lazy { File(filesDir, "home/.kitabucode/extensions") }
    ...
    private val shippedManifest =
        """{"publisher":"kitabucode","name":"kitabucode-process-monitor","version":"1.0.0"}"""
