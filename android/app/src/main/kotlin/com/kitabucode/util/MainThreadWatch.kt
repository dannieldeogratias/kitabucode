 ...
 * `KitabuCodeApp.onCreate`. Everything before that point touches the filesystem on
 ...
 * move the [install] call to `KitabuCodeApp.onCreate` for one run and put it back.
 */
