...
object Environment {
    ...
    fun buildProcessEnvironment(context: Context, port: Int): Map<String, String> {
        ...
        val base = mapOf(
            ...
            "KITABUCODE_EXEC_TABLE" to getExecTablePath(context),
            "TERM" to term,
            ...
            "KITABUCODE_VERSION" to getVersionName(context),
        )
    ...
    fun getUserDataDir(context: Context): String =
        "${context.filesDir}/home/.kitabucode"
    ...
    fun getExtensionsDir(context: Context): String =
        "${context.filesDir}/home/.kitabucode/extensions"

    fun getLogsDir(context: Context): String =
        "${context.filesDir}/home/.kitabucode/data/logs"
