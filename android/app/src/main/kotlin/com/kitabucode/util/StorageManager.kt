...
object StorageManager {
    ...
    fun getStorageBreakdown(context: Context): JSONObject {
        ...
        return JSONObject().apply {
            ...
            put("extensions", dirSize(File(filesDir, "home/.kitabucode/extensions")))
            ...
            put("user_data", dirSize(File(filesDir, "home/.kitabucode/data/User")))
            put("logs", dirSize(File(filesDir, "home/.kitabucode/data/logs")))
     ...
     * `WebView.setDataDirectorySuffix("kitabucode")` gives it, and Chromium holds
     ...
     * 9356 KiB was `webview_kitabucode` and 40 KiB was reachable by the action.
    ...
    fun clearCaches(context: Context): Long {
        ...
        // VS Code logs
        val vscodeLogs = File(context.filesDir, "home/.kitabucode/data/logs")
     ...
     * reclaim in [com.kitabucode.storage.SafStorageManager] used `File.deleteRecursively`,
