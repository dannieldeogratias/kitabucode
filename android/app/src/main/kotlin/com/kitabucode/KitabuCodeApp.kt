...
class KitabuCodeApp : Application() {

    override fun onCreate() {
        super.onCreate()
        WebView.setDataDirectorySuffix("kitabucode")
        Logger.init(this)
        ...
        Logger.i("KitabuCodeApp", "Application created")
    }
    ...
    companion object {
        const val NOTIFICATION_CHANNEL_ID = "kitabucode_server"
...
internal fun preWarmWebView(warm: () -> Unit) {
    try {
        ...
        Logger.w("KitabuCodeApp", "WebView pre-warm failed; continuing without it: ${t.message}")
    }
}
