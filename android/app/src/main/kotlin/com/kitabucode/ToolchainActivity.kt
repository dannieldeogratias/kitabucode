...
import com.kitabucode.setup.ToolchainAction
 ...
 * [com.kitabucode.bridge.AndroidBridge.openToolchainSettings], reached by the
 * `openToolchainSettings` command on the BroadcastChannel relay, which the
 * bundled SAF-bridge extension now sends behind its `kitabucode.manageToolchains`
