...
import com.kitabucode.setup.ToolchainFailure
import com.kitabucode.setup.ToolchainManager
import com.kitabucode.setup.ToolchainCardMode
import com.kitabucode.setup.ToolchainPickerAdapter
...
import com.kitabucode.util.padForSystemBars
...
class SplashActivity : AppCompatActivity() {
    ...
    private fun shouldShowPicker(): Boolean {
        val prefs = getSharedPreferences("kitabucode", MODE_PRIVATE)
        return !prefs.getBoolean("toolchain_picker_shown", false)
    }

    private fun markPickerShown() {
        getSharedPreferences("kitabucode", MODE_PRIVATE).edit() {
     ...
     * the relay, and its `KitabuCode: Manage Toolchains` command is the sender
