package com.kitabucode.service
...
import com.kitabucode.KitabuCodeApp
import com.kitabucode.MainActivity
...
class NodeService : Service() {
     ...
     * was used only to create the channel, in `KitabuCodeApp`.
     */
    private fun removeNotification() {
        getSystemService(NotificationManager::class.java)
            ?.cancel(KitabuCodeApp.NOTIFICATION_ID)
    }
     ...
     * reached nobody, and the notification went on reading "KitabuCode is running"
     ...
     * for the life of the process, with the notification still reading "KitabuCode
     ...
     *
     *     ActivityManager: Start proc 7532:com.kitabucode.debug for service .../NodeService
    ...
    private fun createNotification(
        ...
        val builder = NotificationCompat.Builder(this, KitabuCodeApp.NOTIFICATION_CHANNEL_ID)
    ...
    companion object {
        ...
        const val ACTION_STOP = "com.kitabucode.action.STOP_SERVER"
         ...
         * was never launched.
         */
        const val ACTION_HOLD = "com.kitabucode.action.HOLD_FOR_SETUP"
         ...
         */
        const val ACTION_RELEASE_HOLD = "com.kitabucode.action.RELEASE_SETUP_HOLD"
    }
}
