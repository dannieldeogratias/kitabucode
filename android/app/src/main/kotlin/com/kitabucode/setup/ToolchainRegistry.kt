...
object ToolchainRegistry {
    ...
    val available = listOf(
        ...
        ToolchainInfo(
            ...
            downloadUrl = "https://github.com/rmyndharis/KitabuCode/releases/latest/download/toolchain_java.zip",
        ),
    )
    ...
    // go through [com.kitabucode.util.StorageManager.formatSize] now, like
