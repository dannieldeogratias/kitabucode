#!/usr/bin/env node
/**
 * KitabuCode Server Bootstrap
 * Launches VS Code Server (vscode-reh) with KitabuCode configuration.
 */
...
if (!fs.existsSync(rehEntryPoint)) {
    ...
    // KITABUCODE_DNS_PROXY, which is set on the child's environment below and
    ...
    try {
        ...
        childEnv.KITABUCODE_DNS_PROXY = '1';
    } catch (e) {
