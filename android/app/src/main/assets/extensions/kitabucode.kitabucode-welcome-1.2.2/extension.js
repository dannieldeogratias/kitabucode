...
const WALKTHROUGH_ID = 'kitabucode.kitabucode-welcome#kitabucode.welcome';
...
const SIDE_BAR_ALIGNED = 'kitabucode.secondarySideBar.aligned';
...
function activate(context) {
    ...
    const markerFile = path.join(
        ...
        '.kitabucode_welcome_shown'
    );

    // Command to open the walkthrough manually (from Command Palette)
    context.subscriptions.push(
        vscode.commands.registerCommand('kitabucode.welcome.open', () => {
    ...
    context.subscriptions.push(
        vscode.commands.registerCommand('kitabucode.welcome.toolsDismissed', () => {
