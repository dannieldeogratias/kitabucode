/**
 * KitabuCode platform compatibility fix: SELECTIVE override.
 *
 ...
 * KITABUCODE_PLATFORM_FIX=1) or when node-gyp is detected in argv.
...
if (process.platform === 'android') {
  ...
  process.env.KITABUCODE_REAL_PLATFORM = 'android';

  var shouldFix = false;

  // Opt-in: npm/npx bash functions set this
  if (process.env.KITABUCODE_PLATFORM_FIX === '1') {
    shouldFix = true;
    delete process.env.KITABUCODE_PLATFORM_FIX; // don't propagate to children
  }
