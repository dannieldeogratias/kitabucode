...
PAGES = [
    {
        ...
        "title": "User guide",
        "description": (
            "How to use KitabuCode: the editor, the terminal, extensions, Git and "
    ...
    },
    {
        ...
        "description": "What KitabuCode stores, what it sends, and to whom.",
        "nav": "privacy",
    },
]
...
NAV = [
    ...
    (None, "https://github.com/rmyndharis/KitabuCode", "GitHub"),
]
...
<title>{html.escape(page["title"])} | KitabuCode</title>
<meta name="description" content="{html.escape(page["description"])}">
<meta name="color-scheme" content="light dark">
<link rel="icon" href="assets/kitabucode.png" type="image/png">
...
<header class="site-header">
  <div class="wrap">
    <a class="brand" href="./">
      <img src="assets/kitabucode.png" alt="" width="128" height="128">
      KitabuCode
    </a>
  ...
  <div class="wrap">
    <div class="footer-grid">
      ...
      <nav class="footer-links" aria-label="Footer">
        ...
        <a href="https://github.com/rmyndharis/KitabuCode">Source</a>
        <a href="https://github.com/rmyndharis/KitabuCode/releases">Releases</a>
        <a href="https://github.com/rmyndharis/KitabuCode/issues">Report an issue</a>
      </nav>
    </div>
    <p class="disclaimer">
