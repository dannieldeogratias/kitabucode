...
#
# "KitabuCode" as the component means the file is built from this repository's
...
LIBRARIES = {
    ...
    "libglibc-shim.so": ("KitabuCode", "MIT"),
    "libc.so.6": ("KitabuCode", "MIT"),
    "libdl.so.2": ("KitabuCode", "MIT"),
    "libm.so.6": ("KitabuCode", "MIT"),
    "libpthread.so.0": ("KitabuCode", "MIT"),
    "librt.so.1": ("KitabuCode", "MIT"),
    "libutil.so.1": ("KitabuCode", "MIT"),
    "libresolv.so.2": ("KitabuCode", "MIT"),
    "libcrypt.so.1": ("KitabuCode", "MIT"),
    "ld-linux-aarch64.so.1": ("KitabuCode", "MIT"),
    "libgcc_s.so.1": ("KitabuCode", "MIT"),
    "libexec-trampoline.so": ("KitabuCode", "MIT"),
    "libclaude-launch.so": ("KitabuCode", "MIT"),
    "libseccomp-shim.so": ("KitabuCode", "MIT"),
...
def main():
    ...
    native = {
        ...
        if entry and entry[0] != "KitabuCode" and (n in names or n in built)
    }
    ...
    covered = {c for _, (c, _) in ((n, e) for n, e in for_check if e) } - {"KitabuCode"}
