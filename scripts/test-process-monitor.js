...
const NODE = '/data/data/com.kitabucode/lib/arm64/libnode.so';
...
const PY = '/data/user/0/com.kitabucode/files/usr/bin/python3';
...
const EXT = '/data/user/0/com.kitabucode/files/home/.kitabucode/extensions';
...
const DATA = '/data/user/0/com.kitabucode/files/home/.kitabucode/data';
...
const MIRROR = '/data/user/0/com.kitabucode/files/saf-mirrors/a1b2c3';
...
const { TYPE_LABELS, STALE_AFTER_MS } = require(path.join(
    newestExtensionDir('kitabucode.kitabucode-process-monitor-'), 'extension.js',
));
...
function checkRehAnchorFollowsTheTree(baseTmp) {
    ...
    writeProc(proc, 2002, [NODE, `/data/user/0/com.kitabucode/files/server/vscode-reh/${tail}`, '--stdio']);
    ...
    const snapshot = JSON.parse(fs.readFileSync(path.join(out, 'kitabucode-processes.json'), 'utf8'));
...
function checkSnapshotSurvivesReclaim(baseTmp, proc) {
    ...
    fs.mkdirSync(out);
    process.env.TMPDIR = out;
    const snapshotPath = path.join(out, 'kitabucode-processes.json');
...
function checkSnapshotIsReplacedWhole(baseTmp) {
    ...
    writeProc(proc, 3002, ['/data/data/com.kitabucode/lib/arm64/libbash.so', '-l']);
    process.env.TMPDIR = out;
    const snapshotPath = path.join(out, 'kitabucode-processes.json');
...
function main() {
    const tmp = fs.mkdtempSync(path.join(os.tmpdir(), 'kitabucode-monitor-'));
...
function run(tmp, proc, signals) {
    ...
    writeProc(proc, process.pid, [NODE, '--max-old-space-size=512', '/data/user/0/com.kitabucode/files/server/server.js', '--host=127.0.0.1']);
    ...
    const cases = [
        ...
        [1004, ['/data/data/com.kitabucode/lib/arm64/libbash.so', '-l'], 'terminal'],
        [1005, [NODE, '/data/user/0/com.kitabucode/files/home/projects/my-eslint-tool/index.js'], 'unknown'],
        [1006, [NODE, '/data/user/0/com.kitabucode/files/usr/share/reporter/index.js'], 'unknown'],
        ...
        [1011, [NODE, '/data/user/0/com.kitabucode/files/home/projects/site/tailwind.config.js'],
            'unknown'],
        [1012, [NODE, '/data/user/0/com.kitabucode/files/home/projects/build-tailwind.js'],
            'unknown'],
        ...
        [1013, [NODE, '/data/user/0/com.kitabucode/files/home/projects/site/run-eslint.js'],
            'unknown'],
        ...
        [1036, [NODE, '/data/user/0/com.kitabucode/files/home/projects/site/node_modules/eslint/bin/eslint.js',
            '.'], 'unknown'],
        ...
        [1014, [NODE, '/data/user/0/com.kitabucode/files/home/projects/site/build.js',
        ...
        [1015, ['/data/user/0/com.kitabucode/files/usr/bin/gopls', '-mode=stdio'], 'langserver'],
        ...
        [1019, [NODE, '/data/user/0/com.kitabucode/files/home/projects/node_modules/pyright/dist/pyright-langserver.js',
            '--stdio'], 'langserver'],
        ...
        [1020, [PY, '/data/user/0/com.kitabucode/files/home/projects/tools/jedi-scraper.py'],
            'unknown'],
        [1021, [NODE, '/data/user/0/com.kitabucode/files/home/projects/site/eslintServer.config.js'],
            'unknown'],
        ...
        [1026, [NODE, '/data/user/0/com.kitabucode/files/home/projects/site/cssServerMain.helper.js'],
            'unknown'],
        [1027, [NODE, '/data/user/0/com.kitabucode/files/home/projects/serverWorkerMain-shim.js'],
            'unknown'],
        ...
        [1028, [NODE, '/data/user/0/com.kitabucode/files/home/projects/vscode-eslint-shim.js'],
            'unknown'],
        ...
        [1031, [NODE, '/data/user/0/com.kitabucode/files/home/projects/copilot-demo/index.js'],
            'unknown'],
        ...
        // minutes later.
        [1032, [NODE, '/data/user/0/com.kitabucode/files/home/projects/site/node_modules/@github/copilot-linux-arm64/index.js',
            '--headless'], 'unknown'],
        ...
        [1037, [NODE, '/data/user/0/com.kitabucode/files/home/projects/server-main.js-notes/index.js'],
            'unknown'],
        [1038, [NODE, '/data/user/0/com.kitabucode/files/home/projects/bootstrap-forklift/build.js'],
            'unknown'],
    ];
    ...
    writeProc(proc, 1100, ['com.kitabucode.debug']);
    ...
    const snapshot = JSON.parse(fs.readFileSync(path.join(tmp, 'kitabucode-processes.json'), 'utf8'));
    ...
    const later = JSON.parse(fs.readFileSync(path.join(tmp, 'kitabucode-processes.json'), 'utf8'));
    ...
    fs.writeFileSync(path.join(tmp, 'kitabucode-memory-pressure'), 'critical\n');
    Date.now = () => realNow() + 6 * 60 * 1000;
    try {
        monitor.start({ procRoot: proc });
        monitor.stop();
    ...
    const pressured = JSON.parse(fs.readFileSync(path.join(tmp, 'kitabucode-processes.json'), 'utf8'));
