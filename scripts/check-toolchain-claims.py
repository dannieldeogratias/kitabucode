...
MANAGER = ROOT / "android/app/src/main/kotlin/com/kitabucode/setup/ToolchainManager.kt"
...
def welcome_dir():
    ...
    found = sorted(EXTENSIONS.glob("kitabucode.kitabucode-welcome-*"), key=version)
    if not found:
        sys.exit(
            "FAIL no kitabucode.kitabucode-welcome-* directory under "
