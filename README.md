<p align="center">
  <img src="docs/logo/kitabucode.png" alt="KitabuCode Logo" width="150">
</p>

<h1 align="center">KitabuCode</h1>
...
<p align="center">
  <a href="https://github.com/rmyndharis/KitabuCode/actions/workflows/build.yml"><img src="https://img.shields.io/github/actions/workflow/status/rmyndharis/KitabuCode/build.yml?style=flat-square&logo=github&label=CI" alt="CI"></a>
  <a href="https://github.com/rmyndharis/KitabuCode/releases"><img src="https://img.shields.io/github/v/release/rmyndharis/KitabuCode?style=flat-square&logo=github" alt="Release"></a>
  <a href="LICENSE"><img src="https://img.shields.io/github/license/rmyndharis/KitabuCode?style=flat-square" alt="License"></a>
  <a href="https://github.com/rmyndharis/KitabuCode/stargazers"><img src="https://img.shields.io/github/stars/rmyndharis/KitabuCode?style=flat-square&logo=github" alt="Stars"></a>
  <a href="https://github.com/rmyndharis/KitabuCode/issues"><img src="https://img.shields.io/github/issues/rmyndharis/KitabuCode?style=flat-square" alt="Issues"></a>
</p>
...
---
<p align="center">
  <a href="https://play.google.com/store/apps/details?id=com.kitabucode">
...
>
> KitabuCode is publicly available on Google Play. Download it now and start coding on your Android device.
>
> 🔗 **[Get KitabuCode on Google Play](https://play.google.com/store/apps/details?id=com.kitabucode)**
...
KitabuCode is a refusal of that waiting.
KitabuCode exists for people with talent, discipline, and ideas, but without access to expensive hardware.
...
| Signal                    | Latest data                                                                                                                                          | Why this matters for KitabuCode                                                           |
| ------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------- |
...
- We will keep KitabuCode practical for low-resource conditions, not just high-end setups.
...
KitabuCode runs a local VS Code Server instance on your Android device. The VS Code Web Client renders inside a WebView, and the VS Code Server (Node.js) runs as a native ARM64 process, all on `localhost`.
...
1. **Install** from [Google Play](https://play.google.com/store/apps/details?id=com.kitabucode).
...
> You can also download APKs directly from [GitHub Releases](https://github.com/rmyndharis/KitabuCode/releases).
...
git clone https://github.com/rmyndharis/KitabuCode.git
cd KitabuCode
...
- 🐛 [Report a Bug](https://github.com/rmyndharis/KitabuCode/issues/new?template=bug_report.md)
- 💡 [Request a Feature](https://github.com/rmyndharis/KitabuCode/issues/new?template=feature_request.md)
- 📖 [Documentation](docs/)
...
| [User Guide](docs/USER_GUIDE.md)                                             | How to use KitabuCode (keyboard, terminal, extensions, SSH) |
...
| [Privacy Policy](https://rmyndharis.github.io/KitabuCode/privacy-policy.html) | Data collection and privacy practices                      |
...
KitabuCode is **not affiliated with or endorsed by Microsoft Corporation**.
...
- See [Privacy Policy](https://rmyndharis.github.io/KitabuCode/privacy-policy.html) for data practices.

## 📄 License

KitabuCode's **own** source (the Android app, the build scripts, and the bundled configuration) is licensed under the **MIT License**. See [LICENSE](LICENSE).

That licence does not extend to the third-party components KitabuCode downloads or bundles; each carries its own terms, listed in [NOTICE.md](NOTICE.md).

---

<p align="center">
  <a href="https://github.com/rmyndharis/KitabuCode/discussions">💬 Discussions</a> •
  <a href="https://github.com/rmyndharis/KitabuCode/issues">🐛 Issues</a> •
  <a href="https://github.com/rmyndharis/KitabuCode/releases">📦 Releases</a>
</p>

<p align="center">
  Made with ❤️ for mobile developers everywhere by Yudhi Armyndharis & KitabuCode Community
</p>
