...
| ID | Risk | Prob | Impact | Score | Category |
|----|------|------|--------|-------|----------|
| L01 | **Microsoft trademark** claim against "KitabuCode" name | 2 | 4 | **8** | Medium |
...
>
> The user override (`kitabucode.server.heapCeilingMb`, NFR-RES-07a) narrows the mitigation
