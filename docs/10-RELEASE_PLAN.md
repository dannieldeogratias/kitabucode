...
```
KitabuCode is a full desktop-class code editor that runs entirely on your Android device.
...
Built for developers who code on-the-go. Whether you're on a train, in a coffee shop, or just prefer your tablet, KitabuCode gives you a real development environment.

KitabuCode is built from the MIT-licensed Code - OSS source code.
...
Android's backup service copies `~/.kitabucode/data/Machine`, the editor
